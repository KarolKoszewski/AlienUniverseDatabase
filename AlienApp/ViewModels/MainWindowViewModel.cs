...
{
    public ReactiveCommand<Unit, Unit> DodajFilm { get; }
    public ReactiveCommand<Unit, Unit> UsuńFilm { get; }
    public ReactiveCommand<Unit, Unit> PokazBohatera { get; }
    
     public ObservableCollection<FilmyModel> Filmy { get; } = new()
    {
        new FilmyModel
        {
    ...
    public ObservableCollection<PostacieModel> Postacie { get; } = new()
    {
        new PostacieModel
        {
